...
import { PremiumCard, GridSystem, GridAd, } from './index'
                ...
                <section className="bg-[#f5f5f5] py-8">
                    ...
                    <div className="mx-auto w-11/12 px-4 sm:px-3 lg:px-2 container mt-4" >
                        <div className="row bg-white">
                            ...
                            <GridAd heading={store.heading1} data={store.bringTheSpring} col={2} gap={4} className={'pb-0 p-[50px] text-center '} />
                            <GridAd heading={store.heading2} data={store.occasionStore} col={2} gap={4} className={'pb-0 p-[50px] text-center '} />
                            <GridAd heading={store.heading3} data={store.yourStyles} col={3} gap={4} className={'pb-0 p-[50px] text-center '} />
                            <GridAd heading={store.heading4} data={store.brandEdit} col={3} gap={3} className={'pb-0 p-[50px] text-center '} styles={{ gridTemplateColumns: '1fr 1fr 2fr' }} />
                            <GridAd heading={store.heading5} data={store.trendyAdd} col={3} gap={4} className={'pb-5 p-[50px] text-center '} />
                        </div>
                    </div>
                </section>
